...
def main(img_path=None, vid_path=None,vid_out = None):
    ...
    if img_path != None:
        ...
        img_out_name = f"./img_op/result_{img_path.split('/')[-1]}"
        ...
        frame, plates,n = plot_boxes(results, frame,classes = classes)
...
main(vid_path="C:/Users/Pratik Ghute/Downloads/Screenrecording_20230423_215241.mp4",vid_out="vid_1.mp4") ### for custom video
# main(vid_path=0,vid_out="webcam_facemask_result.mp4") #### for webcam

# main(img_path="D:/dypiu/car_number_plate//4.jpg") ## for image
